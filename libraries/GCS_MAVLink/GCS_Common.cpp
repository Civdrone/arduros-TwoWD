    ...
    case MAV_CMD_GET_CURRETN_POSITION:
        {
            ...
            #else
            gcs().send_text((MAV_SEVERITY)CURRENT_POSITION_MSG, "lat,%d", AP::ahrs()._hp_position.lat);
            gcs().send_text((MAV_SEVERITY)CURRENT_POSITION_MSG, "lat_hp,%d", AP::ahrs()._hp_position.lat_hp);
            gcs().send_text((MAV_SEVERITY)CURRENT_POSITION_MSG, "lng,%d", AP::ahrs()._hp_position.lng);
            gcs().send_text((MAV_SEVERITY)CURRENT_POSITION_MSG, "lng_hp,%d", AP::ahrs()._hp_position.lng_hp);
            gcs().send_text((MAV_SEVERITY)CURRENT_POSITION_MSG, "alt,%d", AP::ahrs()._hp_position.lng_hp);
            #endif
            return MAV_RESULT_ACCEPTED;
        }
